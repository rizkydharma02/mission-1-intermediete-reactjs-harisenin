      ...
      <section className="md:hidden flex flex-col justify-center items-start gap-[40px] p-[20px] border-[#E7E3FC] border-t w-full h-auto">
        ...
        <div className="flex flex-col justify-center items-center gap-[16px] w-full h-auto">
          <div className="flex justify-between items-center w-full">
            <p className="font-lato font-medium text-[16px] text-light-white">Genre</p>
            <img src={dataIcons.arrowRightFooter} className="w-[24px] h-[24px] object-cover" alt="Arrow Right Icon" />
          </div>
          <div className="flex justify-between items-center w-full">
            <p className="font-lato font-medium text-[16px] text-light-white">Bantuan</p>
            <img src={dataIcons.arrowRightFooter} className="w-[24px] h-[24px] object-cover" alt="Arrow Right Icon" />
          </div>
        </div>
      </section>
